    ...
    <div className="bg-white rounded-xl p-6 w-full max-w-md mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          <p className="font-medium text-blue-800">{doctor.name}</p>
          <p className="text-sm text-blue-600">{doctor.specialties.join(', ')}</p>
          <p className="text-sm text-blue-600">{doctor.organizationName}</p>
        </div>
