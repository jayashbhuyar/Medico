          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">{doctorData.experience} Years</p>
              </div>
            </div>
          </motion.div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-lg font-medium">{doctorData.organizationName}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Organization Type</p>
                    <p className="text-lg font-medium">{doctorData.organizationType}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Consultation Fees</p>
                    <p className="text-lg font-medium">₹{doctorData.consultationFees}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Experience</p>
                    <p className="text-lg font-medium">{doctorData.experience} Years</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span>{doctorData.address}, {doctorData.city}, {doctorData.state}</span>
                </div>
                <div className="flex items-center gap-3">
